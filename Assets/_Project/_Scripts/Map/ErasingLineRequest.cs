...
public class ErasingLineRequest
{
    ...
    public ErasingLineRequest(PaintManager paintManager, InputData startInputData, InputData endInputData, float brushSize, System.Action<int, int> onCompleted = null)
    {
    ...
    private void ExecuteDrawLine()
    {
        if (_startRaycastData != null && _endRaycastData != null)
        {
            ...
            // Configure erasing settings
            ConfigureErasingSettings();
    ...
    private void ConfigureErasingSettings()
    {
        if (_paintManager != null)
        {
